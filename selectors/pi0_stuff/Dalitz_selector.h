...
#ifndef Dalitz_selector_h
#define Dalitz_selector_h
...
class Dalitz_selector : public TSelector {
public :
...
float ndesigmas; //number of sigmas for dE/dx cut
   ...
   Dalitz_selector(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Dalitz_selector() { }
   ...
   ClassDef(Dalitz_selector,0);
};

#endif

#ifdef Dalitz_selector_cxx
void Dalitz_selector::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Cinv", &Cinv, &b_Cinv);
...
#endif // #ifdef Dalitz_selector_cxx
